                  ...
                  double *referencePoint, double *newPoint)
{
    ...
    double m, b;
    // need to solve equation y = mx + b for endPoint1 and endPoint2.
...
DelaunayTriangulation::isCollinear(double x1, double y1, double x2, double y2, double x3, double y3) 
{
    ...
    if (std::isinf(slope_a) && std::isinf(slope_b)) {
...
int main()
{
    ...
    //AddPoints to triangulation.  Produces an initial tesselation 
